...
print "Another way this dataset can be organized into a data dictionary is with each state as a key, and the values"
print "associated with each state, such as rate, verbal score, and math score, acting as the value in the key:value"
print "pair."
...
plt.hist(math)
plt.title("Frequency of Math SAT Score")
plt.xlabel("Score")
plt.ylabel("Frequency")
plt.show()
...
plt.hist(verbal)
plt.title("Frequency of Verbal SAT Score")
plt.xlabel("Score")
plt.ylabel("Frequency")
plt.show()
...
# Bonus - Recreate graphs in Seaborn
get_ipython().magic(u'matplotlib inline')
import pandas as pd
import seaborn as sns
